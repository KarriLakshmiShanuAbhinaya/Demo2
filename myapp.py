...
with col1:
  st.markdown("<h3 style='color:#2D9596;'>American Cat</h3>", unsafe_allow_html=True)
...
with col2:
  st.markdown("<h3 style='color:#2D9596;'>Birman</h3>", unsafe_allow_html=True)
...
with col3:
  st.markdown("<h3 style='color:#2D9596;'>Burmes Cat</h3>", unsafe_allow_html=True)
...
with col1:
  st.markdown("<h3 style='color:#2D9596;'>Tom and Jerry</h3>", unsafe_allow_html=True)
