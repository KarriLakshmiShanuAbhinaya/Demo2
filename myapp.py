...
with col1:
  st.markdown("<h3 style='color:#80BCBD;'>American Cat</h3>", unsafe_allow_html=True)
...
with col2:
  st.markdown("<h3 style='color:#80BCBD;'>Birman</h3>", unsafe_allow_html=True)
...
with col3:
  st.markdown("<h3 style='color:#80BCBD;'>Burmes Cat</h3>", unsafe_allow_html=True)
...
with col1:
  st.markdown("<h3 style='color:#80BCBD;'>Tom and Jerry</h3>", unsafe_allow_html=True)
